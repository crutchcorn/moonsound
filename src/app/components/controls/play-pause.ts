  ...
  template: `
      <div
        ...
        style="
          ...
          --color: {{metadata.coverImagePalette.data()?.Vibrant?.titleTextColor}};   
        "
      >
          @if (isPaused()) {
              <button
...
@Component({
  ...
  template: `
      <div class="buttonsRow" style="background-color: {{metadata.coverImagePalette.data()?.DarkVibrant?.hex}}">
